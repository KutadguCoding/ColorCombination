...
public class Colour extends javax.swing.JFrame {
        ...
        jSlider5.addChangeListener(
            new ChangeListener(){
                ...
                public void stateChanged(ChangeEvent e) {
                    jLabel1.setText("Colour Numbers: " + jSlider5.getValue() + " - " + jSlider1.getValue() + " - " + jSlider4.getValue());
                    jPanel1.setBackground(new java.awt.Color(jSlider5.getValue(), jSlider1.getValue(), jSlider4.getValue()));
                    jLabel3.setText("Red: " + jSlider5.getValue());
                }
            }
        );
        jSlider1.addChangeListener(
            new ChangeListener(){
                ...
                public void stateChanged(ChangeEvent e) {
                    jLabel1.setText("Colour Numbers: " + jSlider5.getValue() + " - " + jSlider1.getValue() + " - " + jSlider4.getValue());
                    jPanel1.setBackground(new java.awt.Color(jSlider5.getValue(), jSlider1.getValue(), jSlider4.getValue()));
                    jLabel2.setText("Green: " + jSlider1.getValue());
                }
            }
        );
        jSlider4.addChangeListener(
            new ChangeListener(){
                @Override
                public void stateChanged(ChangeEvent e) {
                    jLabel1.setText("Colour Numbers: " + jSlider5.getValue() + " - " + jSlider1.getValue() + " - " + jSlider4.getValue());
                    jPanel1.setBackground(new java.awt.Color(jSlider5.getValue(), jSlider1.getValue(), jSlider4.getValue()));
                    jLabel4.setText("Blue: " + jSlider4.getValue());
                }
            }
        );
    }
    ...
    private void initComponents() {
        ...
        jSlider5.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jSlider5.setName(""); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jSlider1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
